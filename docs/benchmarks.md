...
<!-- BENCH:TABLES:START -->
<!-- Generated by bench/compare/report.ts — do not edit by hand. Run `pnpm bench:report` to regenerate. -->
...
Source: [`bench/compare/run.ts`](../bench/compare/run.ts), [`bench/compare/generate.ts`](../bench/compare/generate.ts), [`bench/compare/adapters.ts`](../bench/compare/adapters.ts), [`bench/compare/report.ts`](../bench/compare/report.ts). Raw output: [`bench/compare/results/2026-06-12.md`](../bench/compare/results/2026-06-12.md) and [`2026-06-12.json`](../bench/compare/results/2026-06-12.json).
